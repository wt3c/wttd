...
class SubscribePostTest(TestCase):
    ...
    def test_suscription_email_body(self):
        email = mail.outbox[0]
        self.assertIn('Welington Carlos', email.body)
        self.assertIn('123456789101', email.body)
        self.assertIn('carlos@gmail.com', email.body)
        self.assertIn('2198985-6652', email.body)
